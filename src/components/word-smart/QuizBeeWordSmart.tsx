...
import wordSmartGreQuizService from "../../quizService/words_smart_service";
...
class QuizBeeWordSmart extends Component {
    state = {
        questionBank: [],
        score: 0,
        responses: 0,
    ...
    getQuestion = () => {
        wordSmartGreQuizService().then(question => {
            this.setState({
...
export default QuizBeeWordSmart;